...
export default function JsBeautifier() {
  ...
  const handleBeautify = (indentSpaces: number) => {
    if (!input.trim()) {
      setError('Please enter or load JavaScript code to beautify.');
      setOutput('');
      return;
    }
    try {
      ...
      setError('Error formatting JavaScript code. Please check syntax.');
      setOutput('');
    }
  };
  ...
  const handleFetchUrl = async () => {
    ...
    try {
      ...
      alert('Failed to fetch JavaScript code from URL.');
    }
  };
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
        ...
        <div className="lg:col-span-5 space-y-2">
          ...
          <textarea
            ...
            placeholder={`Paste minified JavaScript here...\ne.g. function test(){console.log("hello");return true;}`}
        ...
        <div className="lg:col-span-5 space-y-2">
          ...
          <textarea
            readOnly
            value={output}
            placeholder="Formatted JavaScript code will appear here..."
      ...
      {isUrlModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
          <div className="bg-white rounded-xl shadow-xl border p-6 w-full max-w-md mx-4 space-y-4 animate-in fade-in zoom-in duration-200">
            <h3 className="text-lg font-bold text-gray-800">Load JS from URL</h3>
            <input
              type="url"
