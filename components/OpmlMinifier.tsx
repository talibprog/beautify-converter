...
export default function OpmlMinifier() {
  ...
  const handleBeautify = () => {
    ...
    try {
      ...
      alert('Error processing OPML content.');
    }
  };
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
        ...
        <div className="lg:col-span-5 flex flex-col">
          ...
          <textarea
            ...
            placeholder={'Paste OPML code here...\ne.g. <opml version="2.0">\n  <body>\n    <outline text="Feeds" />\n  </body>\n</opml>'}
        ...
        <div className="lg:col-span-5 flex flex-col">
          ...
          <textarea
            value={outputOpml}
            readOnly
            placeholder="Minified or beautified OPML output will appear here..."
