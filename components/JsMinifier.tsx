...
export default function JsMinifier() {
  ...
  const handleBeautify = () => {
    ...
    let indentLevel = 0;
    const indent = '  ';
    const lines = inputJs.replace(/;\s*/g, ';\n').split('\n');
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
        ...
        <div className="lg:col-span-5 flex flex-col">
          <div className="flex justify-between items-center mb-2">
            <label className="text-sm font-bold text-gray-800 dark:text-gray-200">Input JavaScript:</label>
            <button
              onClick={() => setInputJs('')}
        ...
        <div className="lg:col-span-2 flex flex-col justify-center gap-2.5 pt-8">
          ...
          <button
            onClick={() => { setInputJs(''); setOutputJs(''); }}
        ...
        <div className="lg:col-span-5 flex flex-col">
          ...
          <textarea
            value={outputJs}
            readOnly
            placeholder="Minified or beautified JS result will appear here..."
